...
class OnyxController extends Module {
	...
	static create( config ) { return new OnyxController( config ); }
	...
	constructor ( config ) {
		...
		this.registerTrigger( new ModuleTrigger(
			...
			[
				new ModuleTriggerArg( 'cuelist', 'number', 'onyx cuelist number', false ),
				new ModuleTriggerArg( 'cue', 'number', 'onyx cue, defaults to null', true ),
			],
